...
public class Paint extends JFrame implements ActionListener {
    ...
    private JButton btnSaveTXT = new JButton("Save .png");
    private JButton btnSaveJPG = new JButton("Save .txt");
    ...
    public class DrawCanvas extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            setBackground(new Color(255, 168, 151));
        }
    }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btnColor) {
            ...
            try {
                ...
                //Scanner sc1=new Scanner(GetFile("Png file(.png","png",true));
                lines.clear();
                while (sc.hasNext()) {
                    ...
                    for (int i = 0; i < size; i++)
                        line.addPoint(sc.nextInt(), sc.nextInt());
                ...
                im.getGraphics().fillRect(0, 0, 1500, 1175);
                drawPanel.repaint();
